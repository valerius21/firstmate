...
Do not dispatch until the required tools are present and GitHub authentication is good; a GitLab project also needs its `glab` instance login, which bootstrap does not check (`docs/configuration.md` "Toolchain").
