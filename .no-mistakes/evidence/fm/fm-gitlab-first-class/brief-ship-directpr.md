...
1. First action: create your branch: `git checkout -b fm/ship-directpr`

# Rules
1. Never push to the default branch (push only your `fm/ship-directpr` branch). Never merge a PR.
...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/var/folders/wz/dfpbtyzn3j9b2nzb1pcpm0j40000gn/T//fm-brief-live.prIWIL/home/state/ship-directpr.status'`
...
Firstmate steers you through durable message files in '/var/folders/wz/dfpbtyzn3j9b2nzb1pcpm0j40000gn/T//fm-brief-live.prIWIL/home/state/ship-directpr.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/var/folders/wz/dfpbtyzn3j9b2nzb1pcpm0j40000gn/T//fm-brief-live.prIWIL/home/state/ship-directpr.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/var/folders/wz/dfpbtyzn3j9b2nzb1pcpm0j40000gn/T//fm-brief-live.prIWIL/home/state/ship-directpr.inbox'/NNN.msg '/var/folders/wz/dfpbtyzn3j9b2nzb1pcpm0j40000gn/T//fm-brief-live.prIWIL/home/state/ship-directpr.inbox'/handled/`.
